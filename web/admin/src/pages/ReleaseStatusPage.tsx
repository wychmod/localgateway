    ...
    <section className="page-grid release-layout">
      <article className="luxury-panel page-panel">
        <SectionHeader
          eyebrow="发布状态"
          title="便携版分发与发布状态"
          description="这页负责回答：现在距离“下载后直接用”还差多少。"
        ...
        <div className="status-grid">
          ...
          <div className="metric-pill">版本：0.1.0-alpha</div>
          <div className="metric-pill">分发方式：便携版 / 下载即用</div>
          <div className="metric-pill"><TimerReset size={16} /> 是否可发布：否</div>
        </div>
      </article>

      <article className="luxury-panel page-panel">
        <SectionHeader eyebrow="待办清单" title="发布待办清单" description="真实构建接入前，先把完整链路和界面铺好。" />

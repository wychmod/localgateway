...
// SetDoubleClickHandler registers a callback for double-clicking the tray icon.
// It is currently implemented on Windows; other platforms ignore it.
func SetDoubleClickHandler(handler func()) {
	systrayDoubleClick = handler
}
